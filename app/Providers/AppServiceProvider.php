...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        \Illuminate\Support\Facades\View::composer('*', function ($view) {
            // Map of beautiful fallback images
            $fallbackImages = [
            ...
            // Only fetch if needed to avoid overhead on API/CLI, but fine for small site
            $globalPlants = \App\Models\Plant::active()->get()->map(function($plant) use ($fallbackImages) {
                
                $img = $plant->image_url;
                if (empty($img) || str_contains($img, 'placeholder-plant.jpg')) {
                    $img = $fallbackImages[$plant->slug] ?? 'https://lh3.googleusercontent.com/aida-public/AB6AXuC4Zh-MdixM4lWccvocDjlZcG0rL4wt9rnaB6k6nw5cUneYNN3Kdxd5QLj73n_7ppQNfClMGuqwOJgtyzjant5jvQahKUYgLyvZ-4PFMqDKNN01EaRhD87d4i17Kr9epJmfMBW2lkq1amjWGCXAHL_DtOyGyWvnVN9YksE-ygbF6pF3qdCDiYQbNotG6SaYbPW6U-aoIeLJKkEZrh2hxocpU39IpnQIleVM4Mpm4aZKeTN_q9TCyB75cLK6F5YasURH05VOTkyljzm3';
                }
