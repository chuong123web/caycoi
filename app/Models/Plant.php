...
class Plant extends Model implements HasMedia
{
    ...
    public function registerMediaCollections(): void
    {
        $this->addMediaCollection('images')
            ->useFallbackUrl($this->getDynamicFallbackUrl());
    ...
    /**
     * Get dynamic fallback image URL.
     */
    public function getDynamicFallbackUrl(): string
    {
        $fallbackImages = [
    ...
    {
        $url = $this->getFirstMediaUrl('thumbnail') ?: $this->getFirstMediaUrl('images');
        if (empty($url) || str_contains($url, 'placeholder-plant.jpg')) {
            return $this->getDynamicFallbackUrl();
        }
        return $url;
    }
